...
export async function POST(req: Request): Promise<NextResponse<WebResponse<UserLoginResponse>>> {
    ...
    let user = userUsername ? userUsername : userEmail;


    const userPasswordMatch = await comparePassword(body.password, user!.password);
