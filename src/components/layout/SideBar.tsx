      ...
      <section className={`w-full`}>
        <nav className="">
          <ul className={`flex flex-col gap-5 font-medium text-lg dark:text-white ${poppins.className}`}>
            {/* Menu Items */}
            <li
              className={`${getBorderColor("/latihan")}
                pl-2 pr-10 py-3 hover:cursor-pointer 
                transition-all duration-300 hover:bg-abu/10 hover:rounded-3xl
                hover:shadow-md hover:dark:shadow-coklat/30`}
            >
            ...
            <li
              className={`${getBorderColor("/chatbot")}
                pl-2 pr-10 py-3 hover:cursor-pointer
                transition-all duration-300 hover:bg-abu/10 hover:rounded-3xl
                hover:shadow-md hover:dark:shadow-coklat/30`}
            >
            ...
            <li
              className={`${getBorderColor("/kalkulator")}
                pl-2 pr-10 py-3 hover:cursor-pointer
                transition-all duration-300 hover:bg-abu/10 hover:rounded-3xl
                hover:shadow-md hover:dark:shadow-coklat/30`}
            >
            ...
            {/* Profile */}
            <li
              className={`${borderColorprofile("/profile")} 
                flex flex-col items-center hover:cursor-pointer
                transition-all duration-300 hover:bg-abu/10 hover:rounded-full
                hover:shadow-md hover:dark:shadow-coklat/30 p-2`}
            >
            ...
            {/* Logout */}
            <li
              className="mt-28 w-[135px] h-[40px] hover:cursor-pointer items-center rounded-2xl
                transition-all duration-300 hover:bg-abu/10
                hover:shadow-md hover:dark:shadow-coklat/30"
            >
