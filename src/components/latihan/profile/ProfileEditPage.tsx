...
const ProfileEditPage = ({ onCancel }: { onCancel: () => void }) => {
  return (
    <>
      <div className="flex flex-col lg:flex-row w-full gap-4 lg:gap-0 max-w-[999px] lg:ml-20 xl:ml-72 h-auto min-h-[500px] md:min-h-[600px] lg:h-[742px] bg-black/60 rounded-xl lg:rounded-3xl mx-auto my-6 md:my-5 lg:my-8 px-4 md:px-6 lg:px-8 pt-4 md:pt-6 ">
        <div className="flex flex-col gap-4 md:gap-6 p-5 xl:mt-5 md:p-5 lg:rounded-r-none rounded-3xl w-full lg:w-1/2 bg-abu-abu/25">
          <h1 className="font-semibold text-2xl md:text-[32px] text-center">
            Nama Lengkap
          </h1>
          <div className="mx-auto">
            <Image
              ...
              height={240}
              alt="Random Image"
              className="rounded-full border-4 md:border-5 border-coklat w-40 h-40 md:w-60 md:h-60 lg:w-80 lg:h-80"
            />
          </div>
          <h2 className="font-semibold text-lg md:text-[20px] lg:pl-3">
            Upload Foto
          </h2>
          <div className="w-full flex gap-4">
            ...
            <button className="w-1/4">
              <IoIosArrowDown
                size={30}
                className="bg-black/50 rounded-2xl cursor-pointer"
              />
            </button>
          </div>
        </div>
          ...
          <div className="flex flex-col p-4 md:p-6 gap-3 md:gap-4">
            ...
            <div className="w-full flex flex-col md:flex-row gap-3 md:gap-4">
              <div className="w-full">
                <h2 className="font-semibold text-sm md:text-[15px] text-abu mb-1">
                  Nama Depan
                </h2>
                <input
                  type="text"
                  className="w-full bg-black/50 rounded-xl md:rounded-2xl py-2 px-3 text-sm md:text-base"
                />
              </div>
              <div className="w-full">
                <h2 className="font-semibold text-sm md:text-[15px] text-abu mb-1">
              ...
              <div className="w-full">
                ...
                <div className="flex gap-2 md:gap-3">
                  <input
                    type="text"
                    placeholder="DD"
                    className="w-full bg-black/50 rounded-xl placeholder:text-sm  md:rounded-2xl py-2 px-3 text-sm md:text-base"
                  />
                  <input
                    type="text"
                    placeholder="MM"
                  ...
                  <input
                    type="text"
                    placeholder="YYYY"
                    className="w-full bg-black/50 rounded-xl md:rounded-2xl py-2 px-3  placeholder:text-sm text-sm md:text-base"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="w-full">
              ...
              <input
                type="email"
                className="bg-black/50 rounded-xl md:rounded-2xl w-full py-2 px-3 text-sm md:text-base"
              />
            </div>
