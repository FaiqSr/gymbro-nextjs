...
const ProfileEditPage = ({ onCancel }: { onCancel: () => void }) => {
  return (
    <>
      <div className="flex flex-col lg:flex-row w-full gap-4 lg:gap-0 max-w-[999px] lg:ml-20 xl:ml-72 h-auto min-h-[500px] md:min-h-[600px] lg:h-[742px] bg-black/60 rounded-xl lg:rounded-3xl mx-auto my-6 md:my-8 lg:my-15 px-4 md:px-6 lg:px-8 pt-4 pb-6 md:pt-6">
        <div className="flex flex-col gap-4 md:gap-6 p-4 md:p-5 rounded-l-3xl w-full lg:w-1/2 bg-abu-abu/25">
          ...
          <div className="w-full flex gap-4">
            <div className="w-3/4 h-32 md:h-[30px] bg-black/50 rounded-3xl"></div>
        ...
        <div className="rounded-r-3xl w-full lg:w-1/2 bg-abu-abu/25">
          ...
          <div className="w-full px-4 md:px-6 mt-4 lg:mt-10">
            <button className="rounded-xl md:rounded-2xl py-2 border px-5 float-end hover:ring-2 hover:ring-white hover:transition-transform hover:scale-x-105 hover:duration-300 text-slate-900 bg-abu cursor-pointer hover:text-abutua font-semibold text-sm md:text-base">
              Simpan
            </button>
          </div>
        </div>
